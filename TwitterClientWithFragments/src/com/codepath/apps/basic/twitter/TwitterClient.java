...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getMyInfo(JsonHttpResponseHandler handler/*, long maxId*/) {
		String url = getApiUrl("account/verify_credentials.json");
    	client.get(url, null, handler);
		
	}
	
	public void getUserTimeline(JsonHttpResponseHandler handler/*, long maxId*/) {
		String url = getApiUrl("statuses/user_timeline.json");
    	client.get(url, null, handler);
		
	}
	
	 public void getOtherUserTimeLine(AsyncHttpResponseHandler asyncHandler, String screenName) {
